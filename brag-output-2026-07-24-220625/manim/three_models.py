"""Beat 4 — "One question, three models" (12.5-16.5s in the brag timeline).
...
Smoke test:
    manim -ql --transparent three_models.py ThreeModels

Final render:
    manim -qh --transparent three_models.py ThreeModels
"""
